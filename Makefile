...
help:
	...
	@echo "  make publish-curv-patch        - Publish the curv package with patch bump"
	@echo "  make publish-curvpyutils-patch - Publish the curvpyutils package with patch bump"
	@echo "  make publish-curvtools-patch   - Publish the curvtools package with patch bump"
	@echo "  make publish-curv-minor        - Publish the curv package with minor bump"
	@echo "  make publish-curvpyutils-minor - Publish the curvpyutils package with minor bump"
	@echo "  make publish-curvtools-minor   - Publish the curvtools package with minor bump"
